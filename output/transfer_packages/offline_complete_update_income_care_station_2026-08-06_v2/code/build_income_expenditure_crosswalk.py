...
EXPENDITURE_SPECS = (
    ConceptSpec("EXP_TOTAL_REPORTED", "家庭總支出（直接詢問）", "expenditure", tuple(), {"91_1": ("23",), "91_2": ("23",), "95": tuple(), "99": tuple(), "103": tuple(), "106": tuple(), "110": tuple()}, "question_only", "source_question", "僅91年Q23直接詢問家庭總支出；95年以後無單一總支出題。"),
